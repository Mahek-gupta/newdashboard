...
//         minHeight: "100vh",
//         width: "100%",
//         maxWidth: "100vw", // Screen se bahar jane se rokega
//         overflowX: "hidden", // Left-to-right scroll ko khatam karega
//         px: { xs: 1, sm: 2 }, // Mobile par padding thodi kam ki hai
//         pt: 4,
//         pb: 10, // Logout button ke niche kafi jagah di hai
...
//             <DashboardIcon sx={{ fontSize: { xs: 28, sm: 32 }, color: "#1f2937" }} />
//             <Typography
//               variant="h4"
//               sx={{
//                 fontWeight: 700,
...
//             sx={{ 
//                 wordBreak: "break-word", // Lambi email ko wrap karega
...
//                   Email Address
//                 </Typography>
//                 <Typography variant="body1" sx={{ color: "#1f2937", fontWeight: 500, wordBreak: "break-all" }}>
//                   {user?.email}
//                 </Typography>
//               </Box>
//             </Grid>
