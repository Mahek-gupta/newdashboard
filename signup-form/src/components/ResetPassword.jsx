...
import LockOutlinedIcon from "@mui/icons-material/LockOutlined";
// ✅ Custom api instance use karein (Axios direct nahi)
...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // ✅ End-point path correct kiya aur api instance use kiya
  ...
  return (
    <Box sx={{ minHeight: "100vh", display: "flex", justifyContent: "center", alignItems: "center", background: "linear-gradient(180deg, #cfe9f9 0%, #eef6fb 100%)", px: 2 }}>
          ...
          {success ? (
            ...
            <Box component="form" onSubmit={handleSubmit}>
              ...
              <Button
                ...
                sx={{ mt: 3, py: 1.2, background: "linear-gradient(180deg, #1f2937 0%, #000 100%)", textTransform: "none" }}
              >
