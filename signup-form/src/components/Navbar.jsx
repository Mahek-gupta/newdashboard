...
// <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
//    <ThemeToggle/>
//    {/* LOADING LOGIC YAHAN AAYEGA */}
//               {loading ? (
//                 // Jab loading ho raha ho
//                 <CircularProgress size={24} sx={{ color: 'white' }} />
//               ) : (
//                 // Jab loading khatam ho jaye
//                 <Box sx={{ display: { xs: 'none', md: 'flex' }, gap: 2, alignItems: 'center' }}>
//                   {!user ? (
//                     <>
//                       <Button onClick={() => navigate('/signup')} sx={{ color: '#fff' }}>Sign Up</Button>
//                       <Button onClick={() => navigate('/login')} variant="contained">Login</Button>
//                     </>
//                   ) : (
//                     <>
//                       <Button onClick={() => navigate('/dashboard')} sx={{ color: '#fff' }}>Dashboard</Button>
//                       {user?.role === 'admin' && (
//                         <Button onClick={() => navigate('/admin')} sx={{ color: '#fbbf24' }}>Admin</Button>
//                       )}
//    {/* Profile/Logout buttons */}
// </Box>
...
//   ListItem,
//   ListItemButton,
//   CircularProgress // Yeh import missing tha
// } from '@mui/material'
// import { useNavigate } from 'react-router-dom'
// import MenuIcon from '@mui/icons-material/Menu'
// import LogoutIcon from '@mui/icons-material/Logout'
...
//                           variant="contained"
//                           onClick={() => navigate('/login')}
//                           sx={{ backgroundColor: '#3b82f6', textTransform: 'none', fontWeight: 600 }}
//                         >
//                           Login
//                         </Button>
//                       </>
...
//                             startIcon={<AdminPanelSettingsIcon />}
//                             onClick={() => navigate('/admin')}
//                             sx={{ color: '#fbbf24', textTransform: 'none' }}
//                           >
//                             Admin
//                           </Button>
//                         )}
